        ...
        if (result != null && result.results.Length > 0)
        {
            foreach (var res in result.results)
            {
                foreach (var alt in res.alternatives)
                {
                    ...
                    if (alt.transcript.Contains("Friday") && State.Contains("Final")) 
                    {
                        StartCoroutine(ExampleTextToSpeech.I2_Friday());       
                    }

                    if (text.Contains("dance") && State.Contains("Final")) 
                    {
                    ...
                    if (text.Contains("stop") && State.Contains("Final")) 
                    {
                        // StartCoroutine(ExampleTextToSpeech.I3_Open());
                        flag = "stop";
                    }

                    if (text.Contains("walk") && State.Contains("Final")) 
                    {
                        StartCoroutine(ExampleTextToSpeech.I4_Open());
                        flag = "moonwalk";
                    }

                    if (text.Contains("joke") && State.Contains("Final")) 
                    {
                        StartCoroutine(ExampleTextToSpeech.I6_Open());
                        flag = "joke";
                    }

                    if (text.Contains("meditation") && State.Contains("Final")) 
                    {
                        StartCoroutine(ExampleTextToSpeech.I5_Open());
                        flag = "meditation";
                    }
