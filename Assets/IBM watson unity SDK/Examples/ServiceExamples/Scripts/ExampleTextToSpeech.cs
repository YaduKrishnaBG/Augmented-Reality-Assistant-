...
public class ExampleTextToSpeech : MonoBehaviour
{
    ...
    string _testString = "<speak version=\"1.0\">";
    ...
    private void Update()
    {
        ...
        {
            case 1:
                _testString = "<speak version=\"1.0\"><prosody pitch=\"150Hz\">At your service, sir.</prosody></speak>";  // When the corresponding command is spoken, the assistant will respond with this phrase
                Runnable.Run(Examples()); // Execute the TTS engine.
                SpeakState = 0;
                break;
            case 2:
                _testString = "<speak version=\"1.0\"><prosody pitch=\"170Hz\"><express-as type=\"GoodNews\">Hi I am Friday, How are you doing today? </express-as></prosody></speak>";
                Runnable.Run(Examples());
                SpeakState = 0;
                break;
            case 3:
                _testString = "<speak version=\"1.0\"><prosody pitch=\\\"170Hz\\\"><express-as type=\"GoodNews\">Oh Yes! With pleasure!</express-as></prosody></speak>";
                Runnable.Run(Examples());
                SpeakState = 0;
                break;
            case 4:
                _testString = "<speak version=\"1.0\"><prosody pitch=\"170Hz\">Yes I can.</prosody></speak>";
                Runnable.Run(Examples());
                SpeakState = 0;
                break;
            case 5:
                _testString = "<speak version=\"1.0\"><prosody pitch=\"170Hz\">Health benefits of meditation include better focus concentration and improved self-awareness </prosody></speak>";
                Runnable.Run(Examples());
                SpeakState = 0;
                break;
            case 6:
                _testString = "<speak version=\"1.0\"><prosody pitch=\"170Hz\">Yeah here's something funny. How do robots eat guacamole? With computer chips ha ha haa aa      See I got you! </prosody></speak>";
                Runnable.Run(Examples());
                SpeakState = 0;
                break;
            case 7:
    ...
    public static IEnumerator I2_Friday()
    {
        Debug.Log("friday");
        SpeakState = 2;
        Debug.Log("SpeakState" + SpeakState);
    ...
    public static IEnumerator I4_Open()
    {
        Debug.Log("walk");
        SpeakState = 4;
        Debug.Log("SpeakState" + SpeakState);
    ...
    public static IEnumerator I5_Open()
    {
    ...
    public static IEnumerator I6_Open()
    {
        Debug.Log("joke");
        SpeakState = 6;
        Debug.Log("SpeakState" + SpeakState);
